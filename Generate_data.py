...
class ImagePlotter:
    ...
    def plot_images(self):
        ...
        for i in np.arange(0, 30):
            ...
            axes[i].set_title(self.class_names[np.argmax(labels[i])], color='b')
            axes[i].axis('off')
...
class TrainingHistoryPlotter:
    ...
    def plot(self):
        ...
        ax1.plot(self.history.history['categorical_accuracy'],color='#115ff0')
        ax1.plot(self.history.history['val_categorical_accuracy'],color='#1ba2e0')
        ...
        # Plot loss
        ax2.plot(self.history.history['loss'],color='#115ff0')
        ax2.plot(self.history.history['val_loss'],color='#1ba2e0')
